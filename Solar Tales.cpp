...
#include <vector> // Динамический массив, растет по мере добавления данных, на то он и динамический
#include <limits> // Для очистки входного буфера, ограничения значений
